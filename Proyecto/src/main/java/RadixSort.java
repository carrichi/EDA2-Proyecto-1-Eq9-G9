       ...
       //El segundo recorre los elementos de la lista 
        for(int i=6; i>0; i--){
           ...
           //a escribir, y se repitan 
            ...
            System.out.println("termina iteracion: "+l);
            l++;
...
/* 
 try {
             ...
             FileWriter NoCuenta=new FileWriter("C:\\Users\\Arturo Gonzalez\\Desktop\\Practicas EDa\\ordenacionnumerodecuenta.txt");
             NoCuenta.write("***Fase 1***\n");
